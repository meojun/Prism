...
```bash
git apply /path/to/Prism/exp/analysis/estimator_correction/snapshot/prism_research_worktree.patch
```

Files in the patch: 37
Snapshot taken: 2026-08-25T06:05:25Z
