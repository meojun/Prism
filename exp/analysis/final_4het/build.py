...
OUT = R / "exp/analysis/final_4het"
RAW = R / "exp/results/4het-final/raw"
WL = ["steady", "bursty"]; RATES = [2, 4, 6, 8, 10]; SEEDS = [5, 6]
...
print("FINAL 4-HET (hold-out seeds 5/6)  —  paired Prototype vs Prism\n")
for k in WL:
    print(f"  {k.upper()}")
...
print(f"  validity: {sum(1 for x in rows if x['verdict']=='PASS' and x['lifecycle_gate']=='PASS')}/40 "
