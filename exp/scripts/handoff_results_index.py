#!/usr/bin/env python3
"""reports/prism/00_overview/CURRENT_RESULTS_INDEX.md -- every result and artifact, in one place.
...
def main():
    ...
    A("| how to continue | `reports/prism/00_overview/FINAL_BASELINE_HANDOFF.md` |")
    A("")
    ...
    A("- **GPU-scoped backend queue**: `alg2_seq` is per-GPU while the backend "
      "queue was per-model and shared. See `reports/prism/00_overview/FINAL_BASELINE_HANDOFF.md`; do not "
