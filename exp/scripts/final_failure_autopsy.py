...
KNOWN = [
    ...
    ("staged return type mismatch (fixed 6618671)",
     r"could not return staged .* to the frontend|staged_return_failed",
     "a staged payload could not be handed back and the request was lost"),
