...
def main():
    ...
    manifest = {
        "what_this_is": (
            ...
            "reports/prism/00_overview/FINAL_BASELINE_HANDOFF.md for how to run it on another server."),
        ...
        "handoff": {
            ...
            "document": "reports/prism/00_overview/FINAL_BASELINE_HANDOFF.md",
            "results_index": "reports/prism/00_overview/CURRENT_RESULTS_INDEX.md",
        ...
        "results": {
            ...
            "index": "reports/prism/00_overview/CURRENT_RESULTS_INDEX.md",
        },
        "notes": notes,
    }
